...
const CACHE_NAME = CACHE_PREFIX + '20260706155422';

const PRECACHE_URLS = ["./.last_build_id","./.nojekyll","./404.html","./CNAME","./favicon.png","./flutter.js","./flutter_bootstrap.js","./flutter_service_worker.js","./index.html","./main.dart.js","./main.dart.js_1.part.js","./manifest.json","./og-share.png","./version.json","./assets/AssetManifest.bin","./assets/AssetManifest.bin.json","./assets/FontManifest.json","./assets/NOTICES","./assets/assets/fonts/Roboto-Bold.ttf","./assets/assets/fonts/Roboto-Light.ttf","./assets/assets/fonts/Roboto-Medium.ttf","./assets/assets/fonts/Roboto-Regular.ttf","./assets/assets/images/ngmy_document_ask_icon.png","./assets/assets/images/ngmy_logo.png","./assets/assets/sounds/income_cash.mp3","./assets/assets/sounds/README.md","./assets/assets/sounds/YTMP3GG_YouTube_Kaching-sound-effect-sound-sounds-sounde_Media_a7Vue-A0BOY_007_128k.mp3","./assets/assets/video_studio/yt_news_desk.png","./assets/assets/video_studio/yt_studio_curved.png","./assets/fonts/MaterialIcons-Regular.otf","./assets/packages/cupertino_icons/assets/CupertinoIcons.ttf","./assets/packages/flutter_map/lib/assets/flutter_map_logo.png","./assets/shaders/ink_sparkle.frag","./assets/shaders/stretch_effect.frag","./canvaskit/canvaskit.js","./canvaskit/canvaskit.js.symbols","./canvaskit/canvaskit.wasm","./canvaskit/skwasm.js","./canvaskit/skwasm.js.symbols","./canvaskit/skwasm.wasm","./canvaskit/skwasm_heavy.js","./canvaskit/skwasm_heavy.js.symbols","./canvaskit/skwasm_heavy.wasm","./canvaskit/wimp.js","./canvaskit/wimp.js.symbols","./canvaskit/wimp.wasm","./canvaskit/chromium/canvaskit.js","./canvaskit/chromium/canvaskit.js.symbols","./canvaskit/chromium/canvaskit.wasm","./canvaskit/experimental_webparagraph/canvaskit.js","./canvaskit/experimental_webparagraph/canvaskit.js.symbols","./canvaskit/experimental_webparagraph/canvaskit.wasm","./icons/Icon-192.png","./icons/Icon-512.png","./icons/Icon-maskable-192.png","./icons/Icon-maskable-512.png"];
