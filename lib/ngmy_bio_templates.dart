...
const List<NgmyBioTemplate> kNgmyBioTemplates = [
  ...
  NgmyBioTemplate(
    ...
    headerGradient: [Color(0xFF4C1D95), Color(0xFF1E3A8A), Color(0xFF0F172A)],
    cardRadius: 28,
    cardShadow: false,
    sceneEffect: NgmyBioSceneEffect.marbleVeins,
  ),
  NgmyBioTemplate(
    id: 'neon_night',
    name: 'Nebula',
  ...
  NgmyBioTemplate(
    ...
    name: 'Royal Violet',
    layout: NgmyBioLayoutStyle.curvedOverlap,
    pageBg: Color(0xFF1E0A3C),
    pageBgEnd: Color(0xFF2E1065),
    ...
    cardRadius: 28,
    cardShadow: false,
    sceneEffect: NgmyBioSceneEffect.prismShimmer,
  ),
  NgmyBioTemplate(
    id: 'rose_quartz',
    name: 'Blush Glass',
  ...
  NgmyBioTemplate(
    ...
    linkStyle: NgmyBioLinkStyle.pill,
    headerGradient: [Color(0xFFE2E8F0), Color(0xFFF8FAFC)],
    cardRadius: 28,
    cardShadow: false,
