...
const _noteBackgrounds = <_NoteBackgroundDef>[
  ...
  _NoteBackgroundDef(id: 'boardroom_slate', label: 'Boardroom', category: 'Work', colors: [Color(0xFF334155), Color(0xFF1E293B), Color(0xFF0F172A)], pattern: _NoteBgPattern.bokeh, emojis: ['📊'], darkText: true),
  ...
  _NoteBackgroundDef(id: 'conference_cream', label: 'Conference', category: 'Meeting', colors: [Color(0xFFFFFBEB), Color(0xFFFEF3C7), Color(0xFFFDE68A)], pattern: _NoteBgPattern.bokeh, emojis: ['🤝']),
  ...
  _NoteBackgroundDef(id: 'legal_brief', label: 'Legal Brief', category: 'Work', colors: [Color(0xFFF8FAFC), Color(0xFFCBD5E1), Color(0xFF475569)], pattern: _NoteBgPattern.grid, emojis: ['⚖️']),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      NgmyOfflineEmoji(t.emoji, fontSize: 28),
                                      const Spacer(),
                        ...
                        children: entry.value.map((e) {
                          return InkWell(
                            ...
                            child: Container(
                              ...
                              child: NgmyOfflineEmoji(e, fontSize: 22),
                            ),
                          );
                        }).toList(),
                      ),
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (_, i) {
                  ...
                  return ListTile(
                    leading: NgmyOfflineEmoji(t.emoji, fontSize: 24),
