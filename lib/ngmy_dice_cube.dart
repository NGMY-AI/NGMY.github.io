...
/// Polished 3D-style die — single solid face (no overlapping cube edges).
...
class _Ngmy3DDiceCubeState extends State<Ngmy3DDiceCube> with SingleTickerProviderStateMixin {
        ...
        children: [
          ...
          Transform(
            ...
            transform: Matrix4.identity()
              ..setEntry(3, 2, 0.0025)
              ..rotateX(widget.rolling ? 0.55 + math.sin(t) * 0.35 : 0.52)
