...
List<NgmyInvoiceTemplate> ngmyInvoiceTemplates() => const [
  ...
  NgmyInvoiceTemplate(id: 'ocean', label: 'Ocean', category: kNgmyInvoiceStandardCategory, layout: NgmyInvoiceLayout.modernWave, gradient: [Color(0xFF042F2E), Color(0xFF0D9488)], accent: Color(0xFF14B8A6), accent2: Color(0xFF5EEAD4)),
  ...
  NgmyInvoiceTemplate(id: 'topaz_reign', label: 'Topaz Reign', category: kNgmyInvoiceLuxuryCategory, layout: NgmyInvoiceLayout.luxuryCombo, gradient: [Color(0xFF1F1306), Color(0xFF422006)], accent: Color(0xFFF59E0B), accent2: Color(0xFFFBBF24)),
  NgmyInvoiceTemplate(id: 'frost_sovereign', label: 'Frost Sovereign', category: kNgmyInvoiceLuxuryCategory, layout: NgmyInvoiceLayout.luxuryCombo, gradient: [Color(0xFF0B1220), Color(0xFF1E293B)], accent: Color(0xFF60A5FA), accent2: Color(0xFFA5F3FC)),
  ...
  NgmyInvoiceTemplate(id: 'essential_jade', label: 'Jade Bulletin', category: kNgmyInvoiceLuxuryCategory, layout: NgmyInvoiceLayout.essentialBulletin, gradient: [Color(0xFF021A12), Color(0xFF064E3B), Color(0xFF01140E)], accent: Color(0xFF10B981), accent2: Color(0xFF34D399), essentialLuxury: true),
  NgmyInvoiceTemplate(id: 'essential_steel', label: 'Steel Dispatch', category: kNgmyInvoiceLuxuryCategory, layout: NgmyInvoiceLayout.essentialDispatch, gradient: [Color(0xFF0B0F14), Color(0xFF1E293B), Color(0xFF080B0F)], accent: Color(0xFF94A3B8), accent2: Color(0xFFCBD5E1), essentialLuxury: true),
];
