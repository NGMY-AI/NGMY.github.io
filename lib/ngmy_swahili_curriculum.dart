...
final List<SwahiliLevel> kSwahiliLevels = [
      ...
      SwahiliLessonDay(
        ...
        words: [
          ...
          _w('Ninajaribu', 'I am trying', 'nee-nah-jah-REE-boo', 'Kujaribu = to try. Encouraging word for learners!',
              example: 'Ninajaribu kusema Kiingereza. = I am trying to speak English.'),
  ...
  SwahiliLevel(
    ...
    subtitle: 'See it · read it · understand English',
    icon: Icons.image_rounded,
    color: Color(0xFF0EA5E9),
    days: [
      SwahiliLessonDay(
        title: 'Day 1 — Places & going',
        subtitle: 'Picture phrases for daily movement',
        words: [
          _w('Unaenda wapi?', 'Where are you going?', 'oo-NAH-ehn-dah WAH-pee', 'Ask someone where they are headed — very common daily question.',
              example: 'Unaenda wapi leo? = Where are you going today?'),
          _w('Ninarudi nyumbani', 'I am going back home', 'nee-nah-ROO-dee nyoo-BAH-nee', 'Rudi = return. Nyumbani = home (at home).',
              breakdown: ['Ninarudi = I am returning', 'nyumbani = home']),
          _w('Niko kazini sasa', 'I am at work now', 'NEE-koh kah-ZEE-nee SAH-sah', 'Kazini = at work. Sasa = now.',
              breakdown: ['Niko = I am here', 'kazini = at work', 'sasa = now']),
          _w('Niko shuleni', 'I am at school', 'NEE-koh shoo-LEH-nee', 'Shuleni = at school.',
              example: 'Niko shuleni sasa. = I am at school now.'),
          _w('Leo nina shughuli nyingi', 'I have a lot to do today', 'LEH-oh NEE-nah shoo-GHOO-lee NYIN-gee', 'Shughuli = tasks. Nyingi = many.',
              breakdown: ['Leo = today', 'shughuli = tasks', 'nyingi = many']),
          _w('Kesho nitapumzika', 'I will rest tomorrow', 'KEH-shoh nee-tah-poom-ZEE-kah', 'Kesho = tomorrow. Pumzika = rest.',
              example: 'Leo nafanya kazi, kesho nitapumzika.'),
        ],
      ),
      SwahiliLessonDay(
        title: 'Day 2 — Remember & ideas',
        subtitle: 'Important words with pictures',
        words: [
          _w('Hii ni muhimu sana', 'This is very important', 'HEE-ee nee moo-HEE-moo SAH-nah', 'Muhimu = important. Sana = very.',
              breakdown: ['Hii = this', 'muhimu = important', 'sana = very']),
          _w('Usisahau hilo', "Don't forget that", 'oo-see-sah-HAH-oo HEE-loh', 'Usisahau = do not forget. Hilo = that (thing).',
              example: 'Usisahau kufika kwa wakati. = Don\'t forget to arrive on time.'),
          _w('Nimekumbuka sasa', 'I remember now', 'nee-meh-koom-BOO-kah SAH-sah', 'Kumbuka = remember. Nime- = I have (just).',
              breakdown: ['Nimekumbuka = I remember', 'sasa = now']),
          _w('Nilisahau kabisa', 'I completely forgot', 'nee-lee-sah-HAH-oo kah-BEE-sah', 'Kabisa = completely / totally.',
              example: 'Nilisahau jina lako kabisa. = I completely forgot your name.'),
          _w('Hiyo ni wazo zuri', 'That is a good idea', 'HEE-yoh nee WAH-zoh ZOO-ree', 'Wazo = idea. Zuri = good.',
              breakdown: ['Hiyo = that', 'wazo = idea', 'zuri = good']),
          _w('Ninahitaji msaada', 'I need help', 'nee-nah-hee-TAH-jee m-SAH-ah-dah', 'Essential when learning English — ask for help!',
              example: 'Samahani, ninahitaji msaada. = Excuse me, I need help.'),
        ],
      ),
      SwahiliLessonDay(
        title: 'Day 3 — Hot & cold · big & small',
        subtitle: 'Opposite words with pictures',
        words: [
          _w('Chai ni moto', 'The tea is hot', 'CHAH-ee nee MOH-toh', 'Moto = hot. Chai = tea.',
              example: 'Chai ni moto — subiri kidogo. = The tea is hot — wait a little.'),
          _w('Maji ni baridi', 'The water is cold', 'MAH-jee nee bah-REE-dee', 'Baridi = cold. Maji = water.',
              breakdown: ['Maji = water', 'baridi = cold']),
          _w('Tembo ni kubwa', 'The elephant is big', 'tem-BOH nee KOO-bwah', 'Tembo = elephant. Kubwa = big.',
              example: 'Simba ni kubwa pia. = The lion is also big.'),
          _w('Panya ni mdogo', 'The mouse is small', 'PAHN-yah nee m-DOH-goh', 'Panya = mouse. Mdogo = small.',
              breakdown: ['Panya = mouse', 'mdogo = small']),
          _w('Mimi ni mchangamfu', 'I am happy', 'MEE-mee nee m-chahn-GAHM-foo', 'Mchangamfu = cheerful / lively.',
              example: 'Leo mimi ni mchangamfu! = Today I am happy!'),
          _w('Yeye ana huzuni', 'He/She is sad', 'YEH-yeh AH-nah hoo-ZOO-nee', 'Huzuni = sadness.',
              breakdown: ['Yeye = he/she', 'huzuni = sadness']),
        ],
      ),
      SwahiliLessonDay(
        title: 'Day 4 — Open & close · up & down',
        subtitle: 'More opposite pairs',
        words: [
          _w('Mlango umefunguka', 'The door is open', 'm-LAHN-goh oo-meh-foon-GOO-kah', 'Funguka = open (state).',
              example: 'Mlango umefunguka — ingia! = The door is open — come in!'),
          _w('Mlango umefungwa', 'The door is closed', 'm-LAHN-goh oo-meh-FOONG-wah', 'Fungwa = closed.',
              breakdown: ['Mlango = door', 'umefungwa = is closed']),
          _w('Puto linaenda juu', 'The balloon goes up', 'POO-toh LEE-nah-EHN-dah JOO', 'Juu = up. Juu = above.',
              example: 'Anga linaenda juu. = The sky goes up.'),
          _w('Mpira unaenda chini', 'The ball goes down', 'm-PEE-rah oo-nah-EHN-dah CHEE-nee', 'Chini = down / below.',
              breakdown: ['Mpira = ball', 'chini = down']),
          _w('Asubuhi ni mapema', 'Morning is early', 'ah-soo-BOO-hee nee mah-PEH-mah', 'Mapema = early.',
              example: 'Ninaamka asubuhi mapema. = I wake up early in the morning.'),
          _w('Usiku wa manane', 'It is midnight / late at night', 'oo-SEE-koo wah mah-NAH-neh', 'Manane = midnight. Usiku = night.',
              example: 'Usiku wa manane ni usingizi. = Midnight is sleep time.'),
        ],
      ),
      SwahiliLessonDay(
        title: 'Day 5 — Birds & nature',
        subtitle: 'Picture vocabulary like your examples',
        words: [
          _w('Ndege', 'Bird', 'NDEH-geh', 'General word for bird.',
              example: 'Ndege anaruka angani. = The bird flies in the sky.'),
          _w('Tai', 'Eagle', 'TAH-ee', 'Large bird of prey — strong and powerful.'),
          _w('Bata', 'Duck', 'BAH-tah', 'Water bird — common on lakes.',
              example: 'Bata anaogelea kwenye ziwa. = The duck swims on the lake.'),
          _w('Kuku', 'Chicken', 'KOO-koo', 'Farm bird — also means chicken meat.',
              breakdown: ['Kuku = chicken']),
          _w('Papa', 'Pigeon', 'PAH-pah', 'City bird — common everywhere.',
              example: 'Papa wengi wapo mjini. = Many pigeons are in the city.'),
          _w('Maua ni mazuri', 'Flowers are beautiful', 'mah-OO-ah nee mah-ZOO-ree', 'Maua = flowers. Mazuri = beautiful (plural).',
              example: 'Maua haya ni mazuri sana. = These flowers are very beautiful.'),
        ],
      ),
    ],
  ),
  ...
  SwahiliLevel(
    ...
    days: _swahiliGeneratedDays('fluent', [
      ...
      ['Naweza kuongea Kiingereza', 'I can speak English', 'nah-WEH-zah koo-ohn-GHEH-ah kee-in-geh-REH-zah', 'Milestone phrase!'],
      ['Ninajifunza Kiingereza', 'I am learning English', 'nee-nah-jee-FOON-zah kee-in-geh-REH-zah', 'You are doing it right now!'],
  ...
  SwahiliLevel(
    ...
    days: _swahiliGeneratedDays('native', [
      ...
      ['Mimi ni mzungumzaji wa Kiingereza', 'I am an English speaker', 'MEE-mee nee m-zoon-goom-ZAH-jee wah kee-in-geh-REH-zah', 'You speak the language now.'],
      ['Sasa ninaongea Kiingereza', 'Now I speak English', 'SAH-sah nee-nah-ohn-GEH-ah kee-in-geh-REH-zah', 'Ultimate pride statement — you did it!'],
    ], 'Near Native'),
  ),
];
