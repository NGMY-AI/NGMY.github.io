...
const kVaultGames = <VaultGameDef>[
  ...
  // ── Wave 2: 30 adult-friendly skill games ───────────────────────────────
  VaultGameDef(
    id: 'stack_tower',
    title: 'Stack Tower',
    shortTitle: 'Stack Tower',
    tagline: 'Drop sliding blocks. Build the tallest stack.',
    techLabel: 'STACK',
    engine: VaultEngine.pulseForge,
    colors: [Color(0xFFFBBF24), Color(0xFFF97316)],
  ...
  VaultGameDef(
    ...
    tagline: 'Hit flashing cells before they fade out.',
    techLabel: 'GRID',
    engine: VaultEngine.laserLane,
  ...
  VaultGameDef(
    ...
    tagline: 'Dodge oncoming hazards across three lanes.',
    techLabel: 'RACE',
  ...
  VaultGameDef(
    ...
    tagline: 'Release in the green zone for max power.',
    techLabel: 'LAUNCH',
    engine: VaultEngine.pulseForge,
  ...
  VaultGameDef(
    ...
    tagline: 'Brake soft and land dead-center in the bay.',
    techLabel: 'PARK',
    engine: VaultEngine.gravityHook,
  ...
  VaultGameDef(
    id: 'wheelie_balance',
    title: 'Wheelie Balance',
    shortTitle: 'Wheelie',
    tagline: 'Hold the tilt in the sweet zone. Don’t tip.',
    techLabel: 'BALANCE',
  ...
  VaultGameDef(
    ...
    tagline: 'Endless runway — tap to clear the gaps.',
    techLabel: 'RUN',
    engine: VaultEngine.nodeDash,
  ...
  VaultGameDef(
    ...
    tagline: 'Grab glowing orbs. Avoid the red hazards.',
    techLabel: 'LOOT',
    engine: VaultEngine.orbPop,
  ...
  VaultGameDef(
    ...
    tagline: 'Tap moving targets for crisp accuracy points.',
    techLabel: 'AIM',
    engine: VaultEngine.laserLane,
  ...
  VaultGameDef(
    ...
    tagline: 'Slide the paddle. Smash every brick.',
    techLabel: 'BREAK',
    engine: VaultEngine.pulseForge,
  ...
  VaultGameDef(
    ...
    tagline: 'Tap to flap through the gaps. Don’t crash.',
    techLabel: 'FLAP',
    engine: VaultEngine.gravityHook,
    colors: [Color(0xFF34D399), Color(0xFF22D3EE)],
  ...
  VaultGameDef(
    ...
    tagline: 'Swipe lanes through dense oncoming traffic.',
    techLabel: 'TRAFFIC',
    engine: VaultEngine.nodeDash,
  ...
  VaultGameDef(
    ...
    title: 'Keep Up',
    shortTitle: 'Keep Up',
    tagline: 'Bounce the ball. Never let it hit the floor.',
    techLabel: 'BOUNCE',
    engine: VaultEngine.orbPop,
  ...
  VaultGameDef(
    ...
    tagline: 'Smash lit targets before the pulse dies.',
    techLabel: 'WHACK',
    engine: VaultEngine.pulseForge,
  ...
  VaultGameDef(
    ...
    tagline: 'Swipe-cut falling targets mid-air.',
    techLabel: 'SLICE',
    engine: VaultEngine.laserLane,
  ...
  VaultGameDef(
    id: 'darts_timing',
    title: 'Darts Timing',
    shortTitle: 'Darts Timing',
    tagline: 'Release on the sweet spot for bullseyes.',
    techLabel: 'DARTS',
    engine: VaultEngine.helixHold,
  ...
  VaultGameDef(
    ...
    tagline: 'Arc toss rings onto the glowing pegs.',
    techLabel: 'TOSS',
    engine: VaultEngine.gravityHook,
  ...
  VaultGameDef(
    ...
    title: 'Pinball Bump',
    shortTitle: 'Pinball',
    tagline: 'Flick the ball. Rack bumper points.',
    techLabel: 'PINBALL',
    engine: VaultEngine.orbPop,
    colors: [Color(0xFFFB7185), Color(0xFFFACC15)],
  ...
  VaultGameDef(
    ...
    tagline: 'Ease the craft into the docking ring.',
    techLabel: 'DOCK',
    engine: VaultEngine.helixHold,
  ...
  VaultGameDef(
    ...
    tagline: 'Tap incoming bolts to quench them.',
    techLabel: 'DEFEND',
    engine: VaultEngine.laserLane,
  ...
  VaultGameDef(
    ...
    tagline: 'Tap-jump across moving floating pads.',
    techLabel: 'HOP',
    engine: VaultEngine.nodeDash,
  ...
  VaultGameDef(
    id: 'balance_beam',
    title: 'Balance Beam',
    shortTitle: 'Balance Beam',
    tagline: 'Nudge left and right. Stay on the beam.',
    techLabel: 'BEAM',
    engine: VaultEngine.helixHold,
    colors: [Color(0xFFA78BFA), Color(0xFFEC4899)],
  ...
  VaultGameDef(
    id: 'curl_bowl',
    title: 'Curl Bowl',
    shortTitle: 'Curl Bowl',
    tagline: 'Aim and power a curling shot at the pins.',
    techLabel: 'BOWL',
    engine: VaultEngine.pulseForge,
  ...
  VaultGameDef(
    ...
    tagline: 'Pop rising balloons before they escape.',
    techLabel: 'POP',
    engine: VaultEngine.orbPop,
  ...
  VaultGameDef(
    id: 'spin_stop',
    title: 'Spin Stop',
    shortTitle: 'Spin Stop',
    tagline: 'Stop the dial on the prize wedge.',
    techLabel: 'SPIN',
    engine: VaultEngine.pulseForge,
  ...
  VaultGameDef(
    ...
    tagline: 'Swipe trains into the matching color tubes.',
    techLabel: 'METRO',
    engine: VaultEngine.nodeDash,
  ...
  VaultGameDef(
    ...
    tagline: 'Steer clear of the debris field.',
    techLabel: 'DRIFT',
    engine: VaultEngine.gravityHook,
  ...
  VaultGameDef(
    id: 'slingshot_score',
    title: 'Slingshot Score',
    shortTitle: 'Slingshot',
    tagline: 'Pull-release and hit moving marks.',
    techLabel: 'SLING',
    engine: VaultEngine.laserLane,
  ...
  VaultGameDef(
    ...
    tagline: 'Keep multiple orbs alive by tapping them.',
    techLabel: 'JUGGLE',
    engine: VaultEngine.orbPop,
  ...
  VaultGameDef(
    id: 'vortex_hold',
    title: 'Vortex Hold',
    shortTitle: 'Vortex Hold',
    tagline: 'Drag against the spinning pull. Survive.',
    techLabel: 'VORTEX',
    engine: VaultEngine.helixHold,
